		...
		array(
			...
			'fields'         => array(
				...
				array(
					...
					'name'         => 'video_url',
					'type'         => 'url',
					'instructions' => 'Direct URL to the aftermovie video file (MP4, etc). The page\'s featured image is used as the video poster, or as the hero image when no video is set.',
				),
			),
