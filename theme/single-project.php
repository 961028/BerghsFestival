...
<article>
    <div class="project-hero">
        <div class="container">
            ...
            <?php endif; ?>
            <h1><?php the_title(); ?></h1>
            <?php if ( $company ) : ?><p style="color:#666"><?php echo esc_html( $company ); ?></p><?php endif; ?>
    ...
    <div class="project-content">
        <div class="container">
            <?php if ( $background ) : ?><h2>Background</h2><p><?php echo esc_html( $background ); ?></p><?php endif; ?>
            <?php if ( $solution ) : ?><h2>Solution</h2><p><?php echo esc_html( $solution ); ?></p><?php endif; ?>
            <?php if ( $result ) : ?><h2>Result</h2><p><?php echo esc_html( $result ); ?></p><?php endif; ?>
            <?php $content = get_the_content(); if ( $content ) : the_content(); endif; ?>
        </div>
    </div>
